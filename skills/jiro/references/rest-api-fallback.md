...
2. Reuse the selected Profile. If the task needs to supply, change, or diagnose Credentials, follow [Authentication and profiles](authentication.md). `JIRA_HOST` may independently override the Jira Instance.
